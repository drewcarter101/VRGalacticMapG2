...
public class HIPPARCOS_Data : MonoBehaviour
{
	...
	public Row Find__base(string find)
	{
		return rowList.Find(x => x._base == find);
	}
	public List<Row> FindAll__base(string find)
	{
		return rowList.FindAll(x => x._base == find);
	}
	...
	{
		return rowList.Find(x => x.var == find);
	}
	public List<Row> FindAll_var(string find)
	{
		return rowList.FindAll(x => x.var == find);
	}
